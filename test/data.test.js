const testData = [
    ...
    // [{cmyk: ' c: 0, m: 16, y: 26, k: 21 ', to: 'grayscale' , hexref: true}, { grayscale: 69, hexref: '#B0B0B0' }],
    // [{cmyk: '0, 16, 26, 21 ', to: 'grayscale' , hexref: true}, { grayscale: 69, hexref: '#B0B0B0' }],
    // [{cmyk: '0, 16, 26, 105', to: 'grayscale' , hexref: true}, false],
    // [{cmyk: [0,'13',77,'24%'], to: 'grayscale' , hexref: true}, { grayscale: 64, hexref: '#A3A3A3' }],
    // [{cmyk: 'rgb(10 20 90)', to: 'w'}, false ],
    // [{color: 'rgb(10 20 90)', to: 'w'}, 473 ],
    // [{color: '#76D7D6', to: 'w'}, 507 ],
    // [{color: '#76D7D6', to: 'rgb', grayscale: true }, { r: 186, g: 186, b: 186 } ],
    // [{color: { c: 0, m: 16, y: 26, k: 21 }, to: 'rgb', hexref: true }, { r: 201, g: 169, b: 149, hexref: '#C9A995' }],
    // [{color: ' cmyk 0 16 26 21 ', to: 'rgb', hexref: true }, { r: 201, g: 169, b: 149, hexref: '#C9A995' }],
    // [{color: ' c: 0, m: 16, y: 26, k: 21 ', to: 'rgb', hexref: true }, { r: 201, g: 169, b: 149, hexref: '#C9A995' }],
    // [{color: ' c: 0, m: 16, y: 26, ', to: 'rgb', hexref: true }, 'Inputed color dose not math any color format'],
    // [{color: ' c: 0, m: 16, y: 26, k: 21 ', to: 'rgb', hexref: true }, { r: 201, g: 169, b: 149, hexref: '#C9A995' }],
    // [{color: ' c: 0, m: 16,  k: 21, y: 26,', to: 'rgb', hexref: true }, { r: 201, g: 169, b: 149, hexref: '#C9A995' }],
    // [{color: ' c: 0, m: 16,  k: 21, y: 26,', to: 'rgb', hexref: true }, { r: 201, g: 169, b: 149, hexref: '#C9A995' }],
    ...
    // [{cmyk: { c: 0, m: 16, y: 26, k: 21 }, to: 'html', hexref: true }, { html: 'Tan', hexref: '#D2B48C' }],
    // [{cmyk: { c: 0, m: 16, y: 26, k: 21 }, to: 'rgb', grayscale: true }, { html: 'Tan', hexref: '#D2B48C' }],
    // [{hex: '#f54275', to: 'cmyk', grayscale: true }, 49 ],
    // [{hex: '#782e1c', to: 'ral', }, 'DarkSlateGray' ],
    ...
    // [{cmyk: { c: 0, m: 16, y: 26, k: 21 }, to: 'rgb' }, { html: 'Tan', hexref: '#D2B48C' }],
]
